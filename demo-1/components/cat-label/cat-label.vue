	...
	export default {
		...
		data() {
			return {
				...
				nData:this.dataText ? this.dataText : this.placeholder ? this.placeholder : '点击选择'+ this.title,
...
<style lang="scss">
	...
	// sizeh
	.c-mini{padding: 5px 0;margin: 0 5px;font-size: 14px;font-weight: 600;}
	.c-small{ padding: 10px 0;margin: 0 10px;font-size: 16px;font-weight: 700;}
